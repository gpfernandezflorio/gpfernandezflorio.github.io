\begin{enumerate}[leftmargin=0.8cm]
  ...
  \item[b)]{Carrera De Doctorado.
    ...
    \textbf{Doctorado en Ciencia y Tecnología - Universidad Nacional de Quilmes}
    ...
    \begin{itemize}[leftmargin=0.2cm]
        ...
        \item[] \emph{Director de tesis}: Dr. Christian Cossio Mercado
        \item[] \emph{Co-Director de tesis}: Dr. Agustín Adúriz Bravo
        ...
        \item[] \emph{Fecha de ingreso}: Cohorte 2022.
    \end{itemize}
  ...
  \item[d)]{Tareas de gestión universitaria.
    ...
    \begin{itemize}[leftmargin=0.2cm]
      ...
      {Departamento de Computación (DC) - Facultad de Ciencias Exactas y Naturales (FCEyN) - Universidad de Buneos Aires (UBA)}
