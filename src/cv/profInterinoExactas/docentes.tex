\begin{enumerate}[leftmargin=0.8cm]
  ...
  \item[c)]{Formación pedagogica
    ...
    \begin{itemize}[leftmargin=0.2cm]
      ...
      % Didáctica
      \WorkEntry{Aprobación de la materia\textbf{Didáctica General}}
      {FCEyN - UBA}
      {12 de Diciembre de 2024. Nota: 10}

      % Problemática
      \WorkEntry{Aprobación de la materia\textbf{Problemática Educativa}}
      {FCEyN - UBA}
      {20 de Julio de 2023. Nota: 9}
