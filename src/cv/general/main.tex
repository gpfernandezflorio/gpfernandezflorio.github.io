...
\newcommand{\NombreFecha}[2]{             % Actividades que sólo tienen nombre y fecha
        \noindent \textbf{#1} \par        % Nombre
        \noindent\hangindent=2em\hangafter=0 \small #2 % Fecha
        \normalsize \par }

\newcommand{\SinLugar}[3]{               % Actividades que no tienen una locación
        \noindent \textbf{#1} \\      % Jobname
        #2 \par
        \noindent\hangindent=2em\hangafter=0 \small #3 % Description
        \normalsize \par }

\newcommand{\SinRol}[3]{               % Actividades que no tienen rol
        \noindent \textbf{#1} \\      % Jobname
        %\colorbox{White}{\color{Black}#2} \par  % Duration
